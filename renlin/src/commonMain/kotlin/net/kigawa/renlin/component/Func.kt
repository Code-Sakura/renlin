...
) = net.kigawa.renlin.component.componentInternal(block)
...
fun <CONTENT_CATEGORY: ContentCategory, TAG: Tag<in CONTENT_CATEGORY>, ARG1> Component<TAG>.argComponent(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1) -> Unit,
) = componentInternal(block)

fun <CONTENT_CATEGORY: ContentCategory, TAG: Tag<in CONTENT_CATEGORY>, ARG1, ARG2> Component<TAG>.argComponent(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1, ARG2) -> Unit,
) = componentInternal(block)

fun <CONTENT_CATEGORY: ContentCategory, TAG: Tag<in CONTENT_CATEGORY>, ARG1, ARG2, ARG3> Component<TAG>.argComponent(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1, ARG2, ARG3) -> Unit,
) = componentInternal(block)

fun <CONTENT_CATEGORY: ContentCategory, TAG: Tag<in CONTENT_CATEGORY>, ARG1, ARG2, ARG3, ARG4> Component<TAG>.argComponent(
...
private fun <CONTENT_CATEGORY: ContentCategory, ARG1> componentInternal(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1) -> Unit,
...
private fun <CONTENT_CATEGORY: ContentCategory, ARG1, ARG2> componentInternal(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1, ARG2) -> Unit,
...
private fun <CONTENT_CATEGORY: ContentCategory, ARG1, ARG2, ARG3> componentInternal(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1, ARG2, ARG3) -> Unit,
    ...
    return object: Component3<Tag<CONTENT_CATEGORY>, CONTENT_CATEGORY, ARG1, ARG2, ARG3> {
        override fun render(
            parentDsl: StatedDsl<out CONTENT_CATEGORY>, arg1: ARG1, arg2: ARG2, arg3: ARG3, key: String?,
        ) {
            @OptIn(ExperimentalUuidApi::class)
            val nonNullKey = key ?: Uuid.random().toString()
            val state = parentDsl.dslState.getOrCreateSubDslState(nonNullKey, this)
...
private fun <CONTENT_CATEGORY: ContentCategory, ARG1, ARG2, ARG3, ARG4> componentInternal(
    block: StatedDsl<CONTENT_CATEGORY>.(ARG1, ARG2, ARG3, ARG4) -> Unit,
    ...
    return object: Component4<Tag<CONTENT_CATEGORY>, CONTENT_CATEGORY, ARG1, ARG2, ARG3, ARG4> {
        override fun render(
            parentDsl: StatedDsl<out CONTENT_CATEGORY>, arg1: ARG1, arg2: ARG2, arg3: ARG3, arg4: ARG4, key: String?,
        ) {
            @OptIn(ExperimentalUuidApi::class)
            val nonNullKey = key ?: Uuid.random().toString()
            val state = parentDsl.dslState.getOrCreateSubDslState(nonNullKey, this)
